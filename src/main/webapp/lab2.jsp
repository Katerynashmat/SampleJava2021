...
main {
    ...
    <body>
      <main>
			...
			<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Today is a testing day!</h1>
	                        <p class="hero-paragraph">Do you want to test something interesting? You are right here! If you want to launch our team of professionals then fill in the form below!</p>
							...
							<img class="device-mockup" src="14.jpg" alt="App preview">
							</div>
						</div>
                    </div>
