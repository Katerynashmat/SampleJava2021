...
<%@page import="org.obrii.mit.dp2021.shmat.ShmatKateryna2021.model.Users"%>
...
<main>
    <section>
        ...
        <div class="tbl-content">
            <table cellpadding="0" cellspacing="0" border="0">
                <tbody>
                <c:forEach items="${list_items}" var="data">
                <tr>
                    <td>${data.getId()}</td>
                    <td>${data.getName()}</td>
                    <td>${data.getfName()}</td>
                    ...
                    <th><form action="/update" method="get">
                        ...
                        <input type="hidden" name="familyname" value=${data.getfName()}/>
                    ...
                    <th><form action="/delete" method="get">
                        <input type="hidden" name="number" value=${data.getId()}/>
