            ...
            <div class="tbl-content">
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="familyname" value=${data.getfName()}></td>
                        <td><input type="text" placeholder="integer" name="age" value=${data.getAge()}></td>
                        <td><input type="email" name="email" value=${data.getEmail()}></td>
                    </tr>
                    </tbody>
                </table>
